...
import type { CharacterInterface } from "../utility/interface.utility.ts";


const charaterSchema = new Schema<CharacterInterface>({
  name: {
    type: String,
    required: true,
  },
...
export default mongoose.model<CharacterInterface>("Character", charaterSchema)
